...
//   ------  ----  -------------------------------------------------------------
//      0     4    magic       = "FRKL"
//      4     4    header_size = 24               (uint32)
//      8     4    version     = 1                (uint32)
//     12     4    error       = 8000             (uint32)
//     16     4    dim_k       = error/50         (uint32)  -- turn total buckets
//     20     4    dim_d       = 6                (uint32)  -- dice remaining (1..6)
//
// Data (dim_i * dim_j * dim_k * dim_d float32s, ~475 MB):
//   Row-major, k outermost, d innermost. Offset of P(k,d):
//     flat_index   = k * dim_d + d)
